...
const Configs = {
  ...
  viirsTmpFile:
    process.env.SCHEDULER_VIIRS_TMP_FILE ||
    '/Data/tmp/SUOMI_VIIRS_C2_Global_24h.zip',
  viirsDstFile:
    process.env.SCHEDULER_VIIRS_DST_FILE ||
    '/Data/Datasources/SUOMI_VIIRS_C2_Global_24h.zip',
  viirsUnzipPath:
    process.env.SCHEDULER_VIIRS_UNZIP_PATH ||
  ...
  modisTmpFile:
    process.env.SCHEDULER_MODIS_TMP_FILE ||
    '/Data/tmp/MODIS_C6_1_Global_24h.zip',
  modisDstFile:
    process.env.SCHEDULER_MODIS_DST_FILE ||
    '/Data/Datasources/MODIS_C6_1_Global_24h.zip',
  modisUnzipPath:
    process.env.SCHEDULER_MODIS_UNZIP_PATH ||
